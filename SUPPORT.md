...
- **Full modernization** — a full-workspace pass bringing an entire codebase up to current idioms, plus custom refactoring functions for your codebase's specific patterns. Codebases whose roots predate **DataFlex 2021** (the native-64-bit and full-Unicode watershed) typically carry the most legacy syntax and benefit the most.
