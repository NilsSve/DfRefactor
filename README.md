...
_Click the "<> Code" button and select "Download zip file", then unzip the DataDistrib.zip file to a Data folder and you should be able to open the workspace in the DataFlex Studio._
